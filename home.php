...
<head>
    ...
    <link rel="stylesheet" href="pages/css/nuestros_servicios.css">
</head>
<body>
    <header>
        <nav>
            ...
            <ul>
                <li>
                    <a href="pages/Acerca_de_Nosotros.php">
                    <div class="buttona">
                ...
                <li>
                    <a href="pages/Nuestros_Servicios.php">
                    <div class="buttona">
                ...
                <li>
                    <a href="pages/Credenciales.html">
                    <div class="buttona">
    ...
    <h1 id="number" class="number" >01</h1>
    <div class="content">
    <h3 id="content">Promociones</h3>
    </div>
    <div class="section">
        <div class="supercontainer">
            <div class="bigContainer">
                <img class="items show fade"  src="img/bg.jpg" alt=""/>
                <img class="items fade"  src="img/bg_2.jpg" alt=""/>
                <img class="items fade"  src="img/bg_3.jpg" alt="">
                <img class="items fade"  src="img/bg_4.jpg" alt=""/>
                <img class="items fade"  src="img/bg_5.jpg" alt=""/>
            </div>
            <main>
                <div class="container">
                    <img class="items show"  src="img/bg.jpg" alt=""/>
                    <img class="items"  src="img/bg_2.jpg" alt=""/>
                    <img class="items"  src="img/bg_3.jpg" alt="">
                    <img class="items"  src="img/bg_4.jpg" alt=""/>
                    <img class="items"  src="img/bg_5.jpg" alt=""/>
                </div>
            </main>
            <div class="button">
                <div id="prev"><i class="las la-angle-double-left">←</i></div>
                <div id="next"><i class="las la-angle-double-right">→</i></div>
            </div>
            <script src="./Carousel.js"></script>
        </div>
        <div class="supercontainer">
                <p class="msj">Bienvenidos
                    <i class="fa-solid fa-chevron-down fa-bounce" style="color: #06080a;"></i>
                </p>
        </div>
    </div>
    <section class="section">
    <div class="supercontainer">
        <p class="msj">Calendario</p>
        <img src="img/Calendario.png" height="70%" width="100%">
    </div>
    <div class="supercontainer">
        <p class="msj">Horarios</p>
        <img src="img/horarios.png " height="100%" width="100%">
    </div>
    </section>
</div>
</body>
