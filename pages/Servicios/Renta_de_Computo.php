        ...
        <div class="tables-container">
            <div>
                <table id="rentcomp">
                    ...
                    <tr>
                        <td>
                            <i class="fa-solid fa-computer fa-2xl" style="color: #7a78fd;"></i>
                            <center><button class="but">1</button></center>
                        </td> 
                        <td>HP</td>
                        <td>4GB</td>
                        <td>2.9GHz</td>
                    ...
                    <tr>
                        <td>
                            <i class="fa-solid fa-computer fa-2xl" style="color: #7a78fd;"></i>
                            <center><button class="but">2</button></center>
                        </td>
                        <td>DELL</td>
                        <td>2GB</td>
                        <td>1.7GHz</td>
                    ...
                    <tr>
                        <td>
                            <i class="fa-solid fa-computer fa-2xl" style="color: #7a78fd;"></i>
                            <center><button class="but">3</button></center>
                        </td>        
                        <td>LENOVO</td>
                        <td>2GB</td>
                        <td>1.7GHz</td>
                    ...
                    <tr>
                        <td>
                            <i class="fa-solid fa-computer fa-2xl" style="color: #7a78fd;"></i>
                            <center><button class="but">4</button></center>
                        </td>
                        <td>ACER</td>
                        <td>4GB</td>
                        <td>2.4GHz</td>
                    ...
                    <tr>
                        <td>
                            <i class="fa-solid fa-computer fa-2xl" style="color: #7a78fd;"></i>
                            <center><button class="but">5</button></center>
                        </td>
                        <td>SAMSUNG</td>
                        <td>4GB</td>
                        <td>2.2GHz</td>
            ...
            <div>
                <form action="../pedidos.php" method="POST">
                    <label style="font-size: 15px; font-weight: bold;">Ingresa el numero de la PC a ocupar</label>
                    <input required="" class="input" type="text" name="Rentcomp" id="Rcom" min="1" max="5" style="width: 40px; height: 25px;">
                    <label for="opciones">Selecciona la cantidad de tiempo que ocuparas la pc</label>
                    <select id="opciones" name="opcion_seleccionada">
                        <option value="opcion1">00:30:00</option>
                        <option value="opcion2">01:00:00</option>
                        <option value="opcion3">01:30:00</option>
                        <option value="opcion4">02:00:00</option>
                        <option value="opcion5">02:30:00</option>
                        <option value="opcion6">03:00:00</option>
                    </select>
                    <div class="card-price" id="Total"> </div>
                <input type="hidden" name="valor_pre" value="renta_computadora">
                <input type="hidden" name="totalValue" id="totalValorCom">
                <script>
                const mult = 5;
                const inputnum = document.getElementById('NIC');
                const resultado = document.getElementById('Total');
                const totalValueInput = document.getElementById('totalValorCom');
