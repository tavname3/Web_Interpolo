...
<body>
    ...
    <table>
        <tr>
            <td>
    <div class="card">
        <div class="card-img"><img src="https://tvazteca.brightspotcdn.com/dims4/default/161fe90/2147483647/strip/true/crop/1280x728+0+0/resize/992x565!/format/jpg/quality/90/?url=http%3A%2F%2Ftv-azteca-brightspot.s3.amazonaws.com%2Fd9%2F33%2Fb19c1fef479db5b4000565258cee%2Fcurp-certificada.jpg" width="150px" height="150px"></div>
            <div class="card-title">CURP</div>
            <div class="card-subtitle">$ 15.00 c/u </div>
            <hr class="card-divider">
            <div class="card-footer">
            <div class="card-price">
            <form action="../pedidos.php" method="POST">
                <label style="font-size: 15px; font-weight: bold;">No.</label>
                <input required="" class="input" type="number" name="NCURP" id="NCURP" min="1" max="20" style="width: 50px; height: 25px;">
            </div>
            <div class="card-price" id="Totalcurp"></div>
            <input type="hidden" name="Tipo_serv" value="CURP">
            <input type="hidden" name="valor_pre" value="tramites">
            <input type="hidden" name="totalValue" id="totalValorCurp">
            <script>
                const multb = 15;
                const inputnumb = document.getElementById('NCURP');
                const resultadob = document.getElementById('Totalcurp');
                const totalValorbInput = document.getElementById('totalValorCurp');
                inputnumb.addEventListener('input', function(){
                    const valorb = inputnumb.value;
                    const Totalcurp = valorb*multb;
                    resultadob.textContent = `$ ${Totalcurp}`;
                    totalValorbInput.value = Totalcurp;
                });
            </script>
            ...
            <td>
            <div class="card">
            <div class="card-img"><img src="../../img/INE.jpg" width="120px" height="140px" id="imgcolor"></div>
            <div class="card-title">Cita INE </div>
            <div class="card-subtitle">$ 15.00 c/u </div>
            <hr class="card-divider">
            <div class="card-footer">
            <div class="card-price">
            <form action="../pedidos.php" method="POST">
                <label style="font-size: 15px; font-weight: bold;">No.</label>
                <input required="" class="input" type="number" name="NCINE" id="NCINE" min="1" max="200" style="width: 40px; height: 25px;">
            </div>
            <div class="card-price" id="TotalIne"> </div>
            <input type="hidden" name="Tipo_serv" value="CITA_INE">
            <input type="hidden" name="valor_pre" value="tramites">
            <input type="hidden" name="totalValue" id="totalValorIne">
            <script>
                const multIn = 15;
                const inputnumIn = document.getElementById('NCINE');
                const resultadoIn = document.getElementById('TotalIne');
                const totalValorIneInput = document.getElementById('totalValorIne');
                inputnumIn.addEventListener('input', function(){
                    const valorIn = inputnumIn.value;
                    const Totaline = valorIn*multIn;
                    resultadoIn.textContent = `$ ${Totaline}`;
                    totalValorIneInput.value = Totaline;
                });
                </script>
            <input class="card-btn" type="submit" value="Enviar">
            </form>
            ...
            <td>
            <div class="card">
            <div class="card-img"><img src="../../img/nss.png" width="120px" height="140px" id="imgcolor"></div>
            <div class="card-title">NSS</div>
            <div class="card-subtitle">$ 15.00 c/u </div>
            <hr class="card-divider">
            <div class="card-footer">
            <div class="card-price">
            <form action="../pedidos.php" method="POST">
                <label style="font-size: 15px; font-weight: bold;">No.</label>
                <input required="" class="input" type="number" name="NNSS" id="NNSS" min="1" max="200" style="width: 40px; height: 25px;">
            </div>
            <div class="card-price" id="TotalNss"> </div>
            <input type="hidden" name="Tipo_serv" value="NSS">
            <input type="hidden" name="valor_pre" value="tramites">
            <input type="hidden" name="totalValue" id="totalValorNss">
            <script>
                const mult = 15;
                const inputnum = document.getElementById('NNSS');
                const resultado = document.getElementById('TotalNss');
                const totalValueInput = document.getElementById('totalValorNss');
        
                inputnum.addEventListener('input', function() {
                    const valor = inputnum.value;
                    const Total = valor * mult;
