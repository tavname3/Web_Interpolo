...
<head>
    ...
    <link rel="stylesheet" href="css/nuestros_servicios.css">
        ...
        <div class="container">
            ...
            <label for="c1" class="card">
                <div class="row">
                    ...
                    <div class="description">
                        <a href="Servicios/Impresiones.php"><h4>Impresiones</h4></a>
                    </div>
                </div>
            </label>
            ...
            <label for="c2" class="card">
                <div class="row">
                    ...
                    <div class="description">
                        <a href="Servicios/Recargas.php"><h4>Recargas</h4></a>
                    </div>
                </div>
            </label>
            ...
            <label for="c3" class="card">
                <div class="row">
                    ...
                    <div class="description">
                        <a href="Servicios/Renta_de_Computo.php"><h4>Renta de Compúto</h4></a>
                    </div>
                </div>
            </label>
            ...
            <label for="c4" class="card">
                <div class="row">
                    ...
                    <div class="description">
                        <a href="Servicios/Tramites.php"><h4>Trámites</h4></a>
                    </div>
                </div>
            </label>
            ...
            <label for="c5" class="card">
                <div class="row">
                    ...
                    <div class="description">
                        <a href="Servicios/Escaner.php"><h4>Escáner</h4></a>
                    </div>
                </div>
            </label>
        </div>
